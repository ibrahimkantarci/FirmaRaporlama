...
export const TOOLS = [
  ...
  {
    // GİZLİ: hub'da kart olarak ÇIKMAZ (hidden). Yalnız erişim anahtarı olarak var —
    // "Erişim" sekmesinde "Info / Plans" ya da "notlar" kolonu bu kaydı eşleştirir.
    // Not kağıdı hub sayfasının yanında render edilir (app/notepad.js).
    key: "notlar",
    href: "/",
    title: "Info / Plans",
    desc: "Hub'daki not kağıdı — bilgi ve planlar.",
    hidden: true,
  },
  {
    key: "mvpcall",
...
const ROUTE_MAP = [
  ...
  { prefix: "/api/notlar", key: "notlar" },
  { prefix: "/api/rutinler", key: "notlar" },
  { prefix: "/planlar", key: "notlar" },
  { prefix: "/api/planlar", key: "notlar" },
