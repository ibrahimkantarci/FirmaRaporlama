...
export const DASHBOARD_SOURCES = [
  ...
  {
    key: "verimlilik",
    label: "PY verimlilik (shift — Yıl Ay bazlı aylık)",
    // "PY Sonitel" app → "PY Shiftleri" tablosu (Verimlilik hazır hesaplı gelir).
    appId: PY_SONITEL_APP,
    objectId: "172835cd-6a60-4ee6-bfd1-de34fd985d37",
    tab: "Dashboard_Verimlilik",
    // AY BAZLI: her "%year_month_num" değeri ayrı seçilip PIVOT tablo okunur (obje
    // qMode=P; Verimlilik hazır ölçü). Tarih DEĞİL — Tarih tek güne indirir.
    perMonthField: "%year_month_num",
    selections: [],
  },
  {
    key: "phFlagAy",
    label: "Provider Health flag — ay sonu, PY bazlı (yeşil / yeşil+sarı %)",
    // "Executive Dashboard" app → Provider Health Raw objesi (provider_flag_current ile
    // AYNI obje). Fark: orada yalnız EN GÜNCEL gün çekilir; burada HER AYIN SON GÜNÜ
    // ayrı ayrı seçilip PY (Account Manager) × flag sayımı ÖZETLENEREK yazılır
    // (ham ~2349 satır/gün yerine ay×PY×flag ≈ birkaç yüz satır).
    appId: "3e66f065-9c5d-4d10-8454-9125686c72e8",
    objectId: "97ca7303-a2da-48f3-889c-3db1523a4d7e",
    tab: "Dashboard_PH_Flag_Ay",
    monthEndSnapshot: {
      dateField: "ph_flag_date",
      pyCol: "Account Manager",
      flagCol: "Provider Health Flag",
    },
    selections: [],
  },
  {
    key: "decayTakip",
    label: "Decay takip (renewal_data — canlı Sheet)",
    // Firma bazlı decay takibi. Kural: seçili ay X ise, Başlama Tarihi X'ten BİR YIL
    // ÖNCEKİ aynı ay olan firmalar o ayın kohortudur; Durum = "Decay" olanlar decay
    // olmuştur. Canlı okunur (aracı sekme yok). Sekme adı esnek eşlenir.
    externalSheet: {
      spreadsheetId: "1KM-sTZvsUEDSDsiUfara8Ms5xhZEV06pPXVP97lCzCE",
      tab: "Decay Takip",
      tabMatch: "decay",
    },
  },
  {
    key: "custYenileme",
    label: "Customer bazında yenileme (renewal_data — canlı Sheet)",
    // Harici, sürekli güncellenen renewal_data dosyası. Aracı sekme YOK: data route
    // her açılışta doğrudan canlı okur (externalSheet dalı). Servis hesabının bu
    // dosyada Görüntüleyen olması gerekir; değilse boş döner.
    externalSheet: {
      spreadsheetId: "1KM-sTZvsUEDSDsiUfara8Ms5xhZEV06pPXVP97lCzCE",
      tab: "Customer Bazında Yenileme Tablosu",
    },
  },
];
