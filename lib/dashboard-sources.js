...
export const DASHBOARD_SOURCES = [
  ...
  },
  {
    ...
    // AY BAZLI: her "Yıl Ay" değeri ayrı seçilip tablo çekilir (Tarih DEĞİL — Tarih
    // tek güne indirir). Her satır Yıl Ay ile etiketlenir. PY boyutu "PY" olarak
    // yeniden adlandırılır; ölçü başlıkları (Mesai/Konuşma/Verimlilik…) objeden gelir.
    perMonthField: "Yıl Ay",
    selections: [],
  },
];
